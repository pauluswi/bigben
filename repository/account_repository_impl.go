...
func (repository *accountRepositoryImpl) Update(fromAccountNumber int32, toAccountNumber int32, amount int) (err error) {
...
func (repository *accountRepositoryImpl) Find(accountNumber int32) (balance *entity.Balance, err error) {
	var (
